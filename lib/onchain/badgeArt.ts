...
export const BADGE_META_ES: Record<number, BadgeMeta> = {
  ...
  5: { name: "Barón", description: "Posee 250 bloques" },
  ...
  14: { name: "Máquina", description: "Termina 500 corridas" },
  15: { name: "Leyenda", description: "Termina 1,000 corridas" },
  16: { name: "Gran corrida", description: "5 bloques en una corrida" },
  17: { name: "Maratón", description: "10 km en una corrida" },
  18: { name: "Media maratón", description: "21 km en una corrida" },
  19: { name: "Maratón completa", description: "42 km en una corrida" },
  ...
  26: { name: "Tres días", description: "3 días seguidos" },
  27: { name: "Una semana", description: "7 días seguidos" },
  28: { name: "Dos semanas", description: "14 días seguidos" },
  29: { name: "Un mes", description: "30 días seguidos" },
  30: { name: "Dos meses", description: "60 días seguidos" },
  31: { name: "Tres meses", description: "90 días seguidos" },
  32: { name: "Seis meses", description: "180 días seguidos" },
  33: { name: "Un año", description: "365 días seguidos" },
  ...
  38: { name: "Cartógrafo", description: "Bloques en 50 ciudades" },
  ...
  45: { name: "Señor de la guerra", description: "Captura 100 bloques a rivales" },
  46: { name: "Conquistador", description: "Captura 500 bloques a rivales" },
  47: { name: "Señor supremo", description: "Captura 1,000 bloques a rivales" },
  48: { name: "Primer país", description: "Bloques en tu primer país" },
  49: { name: "Cruzafronteras", description: "Bloques en 2 países" },
  50: { name: "Trotaglobos", description: "Bloques en 5 países" },
  51: { name: "Ciudadano del mundo", description: "Bloques en 10 países" },
  52: { name: "Continental", description: "Bloques en 25 países" },
  53: { name: "Planetario", description: "Bloques en 50 países" },
  54: { name: "Hemisférico", description: "Bloques en 100 países" },
  55: { name: "Mundial", description: "Bloques en 195 países (todos)" },
};
