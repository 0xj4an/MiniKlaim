...
export const dictionaries = {
  en: {
    "home.tagline": "Capture the city. The blocks you cross are yours.",
    ...
    "community.activity.header": "Latest routes",
    ...
    "run.summary.header": "Route complete",
    ...
    "pendingClaim.body":
      "One of your routes never got minted on-chain. Sign the transaction to receive its blocks now.",
    ...
    "stats.card.finishedRuns": "routes completed",
    "stats.card.runs": "routes",
    ...
    "p.badges.of": "of",
    "dashboard.metadata.desc":
      "Live on-chain stats across every chain MiniKlaim runs on.",
    "dashboard.title": "MiniKlaim on-chain dashboard",
    "dashboard.subtitle":
      "Live contract metrics across every chain. Auto-refreshes each minute.",
    "dashboard.section.all": "All chains combined",
    "dashboard.section.perChain": "Per chain",
    "dashboard.stat.hexesCaptured": "Hexes captured",
    "dashboard.stat.claimRunTxs": "Claim-run txs",
    "dashboard.stat.hexPlayers": "Hex players",
    "dashboard.stat.badgesMinted": "Badges minted",
    "dashboard.stat.badgeClaimTxs": "Badge claim txs",
    "dashboard.stat.badgeHolders": "Badge holders",
    "dashboard.chain.notDeployed": "Not deployed on this chain yet.",
    "dashboard.chain.prefix": "chain",
    "dashboard.mini.hexes": "Hexes",
    "dashboard.mini.hexClaimTxs": "Hex claim txs",
    "dashboard.mini.players": "Players",
    "dashboard.mini.badges": "Badges",
    "dashboard.mini.badgeClaimTxs": "Badge claim txs",
  ...
  es: {
    ...
    "community.activity.header": "Últimos recorridos",
    ...
    "run.summary.header": "Recorrido completo",
    ...
    "pendingClaim.body":
      "Uno de tus recorridos no se registro on-chain. Firma la transacción para recibir sus cuadras ahora.",
    ...
    "stats.card.finishedRuns": "recorridos completados",
    "stats.card.runs": "recorridos",
    ...
    "p.title": "Jugador",
    "p.joined": "Se unio en",
    "p.bestRun": "Mejor recorrido:",
    "p.bestRun.blocks": "cuadras",
    "p.longest": "Mas larga:",
    "p.stat.blocks": "cuadras",
    "p.stat.runs": "recorridos",
    ...
    "p.badges.of": "de",
    "dashboard.metadata.desc":
      "Estadísticas on-chain en vivo de cada chain donde MiniKlaim corre.",
    "dashboard.title": "Panel on-chain de MiniKlaim",
    "dashboard.subtitle":
      "Métricas de contrato en vivo en cada chain. Se refresca cada minuto.",
    "dashboard.section.all": "Todas las chains combinadas",
    "dashboard.section.perChain": "Por chain",
    "dashboard.stat.hexesCaptured": "Hexes capturados",
    "dashboard.stat.claimRunTxs": "Txs de claim-run",
    "dashboard.stat.hexPlayers": "Jugadores con hex",
    "dashboard.stat.badgesMinted": "Insignias acuñadas",
    "dashboard.stat.badgeClaimTxs": "Txs de claim de insignias",
    "dashboard.stat.badgeHolders": "Poseedores de insignias",
    "dashboard.chain.notDeployed": "Aún no desplegado en esta chain.",
    "dashboard.chain.prefix": "chain",
    "dashboard.mini.hexes": "Hexes",
    "dashboard.mini.hexClaimTxs": "Txs claim hex",
    "dashboard.mini.players": "Jugadores",
    "dashboard.mini.badges": "Insignias",
    "dashboard.mini.badgeClaimTxs": "Txs claim insignias",
