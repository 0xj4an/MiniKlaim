...
export const dictionaries = {
  en: {
    ...
    "link.steps":
      "On your other wallet (MiniPay or another chain), open Profile and tap \"Link another wallet\" to get a code. Then paste it here:",
    "link.signNote": "You'll sign a free message to prove this wallet is yours.",
    "link.or": "or",
    ...
    "about.trust.header": "Trust & verification",
    "about.trust.contractsLabel": "Contracts on Celo mainnet:",
    "about.trust.txLabel": "Sample on-chain transactions:",
    "about.trust.originsLabel": "External services this app talks to:",
    "about.trust.origins.celoRpc": "Celo RPC (read + write contracts)",
    "about.trust.origins.cartoMap": "Map tiles (no data sent)",
    "about.trust.origins.celoscan": "Celoscan verification + tx lookup",
    "about.trust.origins.metamaskDeeplink": "MetaMask deep link (fallback for iOS users)",
    "about.trust.origins.warpcast": "Warpcast compose intent (share button)",
    ...
    "stats.section.onchain": "On-chain (Celo mainnet)",
    ...
    "stats.card.hexesMinted": "NFTs minted",
    "stats.card.captureTxs": "capture txs",
    "stats.card.onchainHolders": "NFT holders",
    "stats.contracts.title": "Contracts verified on Celoscan",
    "stats.contracts.chain": "Celo (42220)",
    "common.back": "Back",
  ...
  es: {
    ...
    "me.badges.claim.body":
      "Ganaste nuevas insignias. Confirma una transaccion para acuñarlas en tu propia wallet.",
    ...
    "me.link.generate": "Generar codigo",
    "me.link.codeHint": "Ingresa este codigo desde tu otra wallet (10 min).",
    "me.link.enterLabel": "Tenes un codigo? Vincula esta wallet:",
    "me.link.placeholder": "codigo",
    "me.link.cta": "Vincular",
    "me.link.linking": "Firmando...",
    "me.link.linked": "Wallet vinculada!",
    "me.link.error": "No se pudo vincular. Revisa el codigo.",
    "link.haveAccount": "Ya jugas en otra wallet? Vincula esta",
    "link.steps":
      "En tu otra wallet (MiniPay u otra chain), anda a Perfil y toca \"Vincular otra wallet\" para obtener un codigo. Despues pegalo aca:",
    "link.signNote": "Vas a firmar un mensaje (gratis) para probar que esta wallet es tuya.",
    "link.or": "o",
    ...
    "me.wallet.subtitle":
      "Mostrado como referencia. MiniKlaim no recibe pagos. Recompensas proximamente.",
    ...
    "pendingClaim.title": "Termina de reclamar tu ultima corrida",
    "pendingClaim.body":
      "Una de tus corridas no se registro on-chain. Firma la transaccion para recibir sus cuadras ahora.",
    "pendingClaim.blocks": "Cuadras",
    "pendingClaim.distance": "Dist",
    "pendingClaim.cta": "Reclamar",
    "pendingClaim.pending": "Confirmando...",
    "pendingClaim.later": "Despues",
    ...
    "about.sla.body":
      "Los problemas criticos (sign-in roto, corridas perdidas, fallas de mint en cadena) se resuelven en menos de 24 horas. Escribi por X para respuesta mas rapida.",
    "about.trust.header": "Confianza y verificacion",
    "about.trust.contractsLabel": "Contratos en Celo mainnet:",
    "about.trust.txLabel": "Transacciones de muestra en cadena:",
    "about.trust.originsLabel": "Servicios externos a los que esta app llama:",
    "about.trust.origins.celoRpc": "Celo RPC (lectura + escritura de contratos)",
    "about.trust.origins.cartoMap": "Tiles del mapa (no enviamos datos)",
    "about.trust.origins.celoscan": "Verificacion en Celoscan y lookup de tx",
    "about.trust.origins.metamaskDeeplink": "Deep link de MetaMask (fallback para iOS)",
    "about.trust.origins.warpcast": "Compose de Warpcast (boton compartir)",
    ...
    "stats.section.onchain": "En cadena (Celo mainnet)",
    ...
    "stats.card.hexesMinted": "NFTs acunados",
    "stats.card.captureTxs": "txs de captura",
    "stats.card.onchainHolders": "holders de NFT",
    "stats.contracts.title": "Contratos verificados en Celoscan",
    "stats.contracts.chain": "Celo (42220)",
